...
const UserScema = new mongoose.Schema(

    {
        ...
        nomineeFathername: { type: String },
        nomineeMothername: { type: String },
...
const Payment = new mongoose.Schema({
    ...
    amount: { type: Number },
    payForMonth: { type: String },
    monthNumbr: { type: Number },
    payForYear: { type: Number },
    userProfile: { type: String },
    paymentSuccess: { type: Boolean, default: false }
}, { timestamps: true });

const AmountScema = new mongoose.Schema({
